...
BOT_SPAM_CHANNEL_ID = os.getenv('BOT_SPAM_CHANNEL_ID')
ROLE_REACTION_MESSAGE_ID = os.getenv('ROLE_REACTION_MESSAGE_ID')
AUEL_ID = os.getenv('AUEL_ID')
FRIEDE_ID = os.getenv('FRIEDE_ID')
CARI_ID = os.getenv('CARI_ID')
CHI_ID = os.getenv('CHI_ID')
SALTY_ID = os.getenv('SALTY_ID')
DENNIS_ID = os.getenv('DENNIS_ID')
LEIF_ID = os.getenv('LEIF_ID')
AKKO_ID = os.getenv('AKKO_ID')
